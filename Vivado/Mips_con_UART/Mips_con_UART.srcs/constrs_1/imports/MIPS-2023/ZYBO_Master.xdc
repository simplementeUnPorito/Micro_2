...
## UART RX por JE10 (pin 10 del Pmod JE)
set_property -dict { PACKAGE_PIN Y17 IOSTANDARD LVCMOS33 } [get_ports { rx1 }];
## UART TX out por JE9 (pin 9 del Pmod JE)
...
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { rx0 }]; #IO_L18N_T2_34 Sch=JE2
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { tx0 }]; #IO_25_35 Sch=JE3
