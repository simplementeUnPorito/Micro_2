...
#
# Script generated by Vivado on Mon May 19 18:54:07 -0300 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/Mips_con_UART/Mips_con_UART.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
