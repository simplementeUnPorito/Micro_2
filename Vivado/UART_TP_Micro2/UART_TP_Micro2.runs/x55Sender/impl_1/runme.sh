...
HD_PWD='C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/UART_TP_Micro2/UART_TP_Micro2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_test_sender.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_test_sender.tcl -notrace
