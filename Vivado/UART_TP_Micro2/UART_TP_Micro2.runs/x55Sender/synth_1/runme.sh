...
HD_PWD='C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/UART_TP_Micro2/UART_TP_Micro2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_test_sender.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_test_sender.tcl
