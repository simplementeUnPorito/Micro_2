...
#                script (type 'tb_uart.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/UART_TP_Micro2/UART_TP_Micro2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
