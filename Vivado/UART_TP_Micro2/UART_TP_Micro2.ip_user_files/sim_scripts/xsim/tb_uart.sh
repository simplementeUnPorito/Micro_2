...
#
# Script generated by Vivado on Mon May 19 18:53:50 -0300 2025
...
#
# Usage        : tb_uart.sh
#                tb_uart.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_uart.sh [-reset_run]
#                tb_uart.sh [-reset_log]
#                tb_uart.sh [-help]
#
...
# script info
echo -e "tb_uart.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_uart.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot tb_uart xil_defaultlib.tb_uart -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_uart -key {Behavioral:sim_1:Functional:tb_uart} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_uart.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_uart.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_uart.sh [-help]\n\
Usage: tb_uart.sh [-step]\n\
Usage: tb_uart.sh [-lib_map_path]\n\
Usage: tb_uart.sh [-reset_run]\n\
Usage: tb_uart.sh [-reset_log]\n\
Usage: tb_uart.sh [-keep_index]\n\
Usage: tb_uart.sh [-noclean_files]\n\n\
