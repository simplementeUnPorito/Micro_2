...
HD_PWD='C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/upDownCounter/upDownCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonCounter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ButtonCounter.tcl -notrace
