...
HD_PWD='C:/Users/Elias/OneDrive/UCA/9_Semestre/Micro_2/Vivado/upDownCounter/upDownCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ButtonCounter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ButtonCounter.tcl
